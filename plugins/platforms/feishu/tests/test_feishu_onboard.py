...
class TestPostRegistration:
    ...
    @patch("hermes_agent_feishu.adapter.urlopen")
    def test_post_registration_returns_parsed_json(self, mock_urlopen_fn):
        from hermes_agent_feishu.adapter import _post_registration
...
class TestInitRegistration:
    ...
    def test_init_succeeds_when_client_secret_supported(self, mock_urlopen_fn):
        from hermes_agent_feishu.adapter import _init_registration
...
class TestBeginRegistration:
    ...
    def test_begin_returns_device_code_and_qr_url(self, mock_urlopen_fn):
        from hermes_agent_feishu.adapter import _begin_registration
...
class TestPollRegistration:
    ...
    @patch("hermes_agent_feishu.adapter.time")
    @patch("hermes_agent_feishu.adapter.urlopen")
    def test_poll_returns_credentials_on_success(self, mock_urlopen_fn, mock_time):
        from hermes_agent_feishu.adapter import _poll_registration
...
class TestRenderQr:
    ...
    @patch("hermes_agent_feishu.adapter._qrcode_mod", create=True)
    def test_render_qr_returns_true_on_success(self, mock_qrcode_mod):
        from hermes_agent_feishu.adapter import _render_qr
    ...
    def test_render_qr_returns_false_when_qrcode_missing(self):
        ...
        with patch("hermes_agent_feishu.adapter._qrcode_mod", None):
...
class TestProbeBot:
    ...
    def test_probe_returns_bot_info_on_success(self):
        from hermes_agent_feishu.adapter import probe_bot

        with patch("hermes_agent_feishu.adapter._probe_bot_sdk") as mock_sdk:
    ...
    @patch("hermes_agent_feishu.adapter.FEISHU_AVAILABLE", False)
    @patch("hermes_agent_feishu.adapter.urlopen")
...
class TestQrRegister:
    ...
    @patch("hermes_agent_feishu.adapter.probe_bot")
    @patch("hermes_agent_feishu.adapter._render_qr")
    @patch("hermes_agent_feishu.adapter._poll_registration")
    @patch("hermes_agent_feishu.adapter._begin_registration")
    @patch("hermes_agent_feishu.adapter._init_registration")
    def test_qr_register_success_flow(
        self, mock_init, mock_begin, mock_poll, mock_render, mock_probe
    ):
        from hermes_agent_feishu.adapter import qr_register
